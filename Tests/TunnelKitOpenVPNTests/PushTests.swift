...
private extension OpenVPN.RecentConnections {
    func debug() {
    }
}
...
class PushTests: XCTestCase {
    ...
    func testNet30() {
        ...
        let reply = try! OpenVPN.RecentConnections(message: msg)!
        reply.debug()

        XCTAssertEqual(reply.more.ipv4?.address, "10.5.10.6")
        XCTAssertEqual(reply.more.ipv4?.addressMask, "255.255.255.255")
        XCTAssertEqual(reply.more.ipv4?.defaultGateway, "10.5.10.5")
        XCTAssertEqual(reply.more.dnsServers, ["209.222.18.222", "209.222.18.218"])
    }
    ...
    func testSubnet() {
        ...
        XCTAssertEqual(reply.more.ipv4?.address, "10.8.0.2")
        XCTAssertEqual(reply.more.ipv4?.addressMask, "255.255.255.0")
        XCTAssertEqual(reply.more.ipv4?.defaultGateway, "10.8.0.1")
        XCTAssertEqual(reply.more.dnsServers, ["8.8.8.8", "4.4.4.4"])
    }
    ...
    func testRoute() {
        ...
        let route = reply.more.routes4!.first!
    ...
    func testIPv6() {
        ...
        XCTAssertEqual(reply.more.ipv4?.addressMask, "255.255.255.0")
        XCTAssertEqual(reply.more.ipv4?.defaultGateway, "10.8.0.1")
        XCTAssertEqual(reply.more.ipv6?.address, "fe80::601:30ff:feb7:ec01")
        XCTAssertEqual(reply.more.ipv6?.addressPrefixLength, 64)
        XCTAssertEqual(reply.more.ipv6?.defaultGateway, "fe80::601:30ff:feb7:dc02")
        XCTAssertEqual(reply.more.dnsServers, ["2001:4860:4860::8888", "2001:4860:4860::8844"])
    }
    ...
    func testCompressionFraming() {
        ...
        XCTAssertEqual(reply.more.compressionFraming, .compLZO)
    }
    ...
    func testCompression() {
        ...
        var reply: OpenVPN.RecentConnections

        reply = try! OpenVPN.RecentConnections(message: msg.appending(",comp-lzo no"))!
        reply.debug()
        XCTAssertEqual(reply.more.compressionFraming, .compLZO)
        XCTAssertEqual(reply.more.compressionAlgorithm, .disabled)

        reply = try! OpenVPN.RecentConnections(message: msg.appending(",comp-lzo"))!
        reply.debug()
        XCTAssertEqual(reply.more.compressionFraming, .compLZO)
        XCTAssertEqual(reply.more.compressionAlgorithm, .LZO)

        reply = try! OpenVPN.RecentConnections(message: msg.appending(",comp-lzo yes"))!
        reply.debug()
        XCTAssertEqual(reply.more.compressionFraming, .compLZO)
        XCTAssertEqual(reply.more.compressionAlgorithm, .LZO)

        reply = try! OpenVPN.RecentConnections(message: msg.appending(",compress"))!
        reply.debug()
        XCTAssertEqual(reply.more.compressionFraming, .compress)
        XCTAssertEqual(reply.more.compressionAlgorithm, .disabled)

        reply = try! OpenVPN.RecentConnections(message: msg.appending(",compress lz4"))!
        reply.debug()
        XCTAssertEqual(reply.more.compressionFraming, .compress)
        XCTAssertEqual(reply.more.compressionAlgorithm, .other)
    }
    ...
    func testNCP() {
        ...
        XCTAssertEqual(reply.more.cipher, .aes256gcm)
    }
    ...
    func testPing() {
        ...
        XCTAssertEqual(reply.more.keepAliveInterval, 10)
    }
    ...
    func testPingRestart() {
        ...
        XCTAssertEqual(reply.more.keepAliveTimeout, 60)
    }
    ...
    func testPeerInfo() {
        _ = OpenVpnMainConfig.OpenVPN.platformCheck()
    }
}
